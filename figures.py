...
if __name__ == '__main__':
    # The following sets the working directory where the analysis is performed, and the corresponding results are saved.
    ...
    bar_plot()
    # The following creates Figure 2. and Figure 3. of the paper where the targeted attack considered is respectively static and dynamic.
    ...
    # The following creates a visualization of the Collins yeast interactome network as displayed in Figure 4. of the paper.
    draw_collins_yeast()
